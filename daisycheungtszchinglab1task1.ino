...
void setup() {
  ...
  Serial.println("duty cycle,Vout"); // display duty cycle,Vout for TASK 1 or I,Vout for Task 2 3 4
  for (int onPeriod = 0; onPeriod < 256; onPeriod++) 
    ...
    // read the voltage level at the node for current calcultion  
   //calculate the voltage at the node for current calcultion  
    x = float(onPeriod)*100/255; // calculate duty cycle for TASK 1 or the voltage at Vout in mV for Task 2 3 4
